...
int main() {
	...
	// (10)
	Mat Hough_Rice = CI.GS_basicHoughTransformGray(Binary_Rice);
	Mat Hough_Stuff_Color = CI.GS_basicHoughTransformGray(Binary_Stuff_Color);
	imshow("Hough_Rice", Hough_Rice);
	imshow("Hough_Stuff_Color", Hough_Stuff_Color);
