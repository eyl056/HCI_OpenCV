...
int main() {
	...
	Mat Add_Lenna = CP.GS_add_image(Gray_Lenna, Sub_Lenna);
	Mat Add_Jenny = CP.GS_add_image(Gray_Jenny, Sub_Jenny);

	imshow("Add_Lenna", Add_Lenna);
	imshow("Add_Jenny", Add_Jenny);
